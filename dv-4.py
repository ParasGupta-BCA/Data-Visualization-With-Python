...
print("Student Performance Analysis Dataset:\n")
print(df.head())
...
print("\nMaximum value of Marks attributes:\n")
...
#Step-6: Count number of records for each distinct class (Subject)
print("\nNumber of records for each Subject:")
class_count=df['Subject'].value_counts()
print(class_count)
